INSERT INTO  silver_screenr_db . user  ( id ,  username ,  email ,  password ,  default_public ) VALUES ('1', 'Test User', 'test@test.test', '$2b$10$AUSai4ho.HBQt.IkpS9OtuRPdZGVsOmk2oqkp96ofaw//W6kxj7lS', '1');
